...
- [ ] T001: Create `server/api/specs/features.get.ts` endpoint [FR-017]
...
- [ ] T002: Create `server/api/specs/[featureId]/[...filename].get.ts` endpoint [FR-018]
  - Read requested markdown file content
  - Validate path to prevent directory traversal
  - Return raw markdown content

- [ ] T003: Create `server/api/specs/[featureId]/[...filename].put.ts` endpoint [FR-020, FR-022]
...
- [ ] T004: Create `types/spec-viewer.ts` with Feature and SpecFile types [FR-001, FR-002]

- [ ] T005: Create `composables/useMarkdown.ts` for client-side markdown rendering [FR-005]
  - Use marked library for parsing
  - Use dompurify for sanitization
  - Export renderMarkdown function

- [ ] T006: Create `components/features/FeatureCard.vue` [FR-002, FR-015, FR-016]
...
- [ ] T007: Create `components/features/SpecFileViewer.vue` [FR-004, FR-005]
...
- [ ] T008: Create `components/features/FeaturesPanel.vue` main container [FR-001, FR-003, FR-006, FR-014]
...
- [ ] T009: Add cascade buttons to FeatureCard.vue [FR-007]
...
- [ ] T010: Implement cascade button click handlers [FR-008, FR-009, FR-010]
...
- [ ] T013: Implement active feature highlighting in FeatureCard.vue [FR-012]
...
- [ ] T014: Implement auto-scroll to active feature [FR-013]
...
- [ ] T018: Replace placeholder in `layouts/default.vue` Column 2
  - Remove "Spec viewer coming soon" text
  - Mount new FeaturesPanel component

- [ ] T19: Test full user flows
